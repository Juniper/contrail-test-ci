...
class VncDriver:
    ...
    def __init__ (self, username, password, project_name, domain_name,
    ...
    def _create (self, resource, **kwargs):
        ...
        obj._pending_field_updates.update(_RESOURCES[resource].ref_fields)
        return fn(obj)
    ...
    def _update (self, resource, obj=None, uuid=None, **kwargs):
        ...
        obj_upd._pending_field_updates.update(_RESOURCES[resource].ref_fields)
        return fn(obj_upd)
