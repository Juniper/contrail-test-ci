...
class VerifyIntfMirror(VerifySvcMirror):
    ...
    def create_sub_intfj(self, vn_fix_uuid, intf_type, vlan=101, mac_address=None):
    ...
    def verify_intf_mirroring(self, compute_nodes, vn_index_list, sub_intf=False):
        ...
        if vn_index_list[0] == 0:
           ...
           if sub_intf:
               intf_type = 'src'
               self.src_port = self.create_sub_intfj(self.vn1_fixture.uuid, intf_type)
           ...
           if sub_intf:
               intf_type = 'src'
               self.src_port = self.create_sub_intfj(self.vn2_fixture.uuid, intf_type)
        else:
           ...
           if sub_intf:
               intf_type = 'src'
               self.src_port = self.create_sub_intfj(self.vn3_fixture.uuid, intf_type)
        ...
        if vn_index_list[1] == 0:
           ...
           if sub_intf:
               intf_type = 'dst'
               self.dst_port = self.create_sub_intfj(self.vn1_fixture.uuid, intf_type)
           ...
           if sub_intf:
               intf_type = 'dst'
               self.dst_port = self.create_sub_intfj(self.vn2_fixture.uuid, intf_type)
        else:
           ...
           if sub_intf:
               intf_type = 'dst'
               self.dst_port = self.create_sub_intfj(self.vn3_fixture.uuid, intf_type)
        ...
        if vn_index_list[2] == 0:
           ...
           if sub_intf:
               intf_type = 'analyzer'
               self.analyzer_port = self.create_sub_intfj(self.vn1_fixture.uuid, intf_type)
           ...
           if sub_intf:
               intf_type = 'analyzer'
               self.analyzer_port = self.create_sub_intfj(self.vn2_fixture.uuid, intf_type)
        else:
           ...
           if sub_intf:
               intf_type = 'analyzer'
               self.analyzer_port = self.create_sub_intfj(self.vn3_fixture.uuid, intf_type)
