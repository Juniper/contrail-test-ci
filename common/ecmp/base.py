...
class ECMPTestBase(GenericTestBase):
    ...
    def setUpClass(cls):
        ...
        # Mgmt VN
        cls.mgmt_vn_name = get_random_name("mgmt_vn")
    ...
    def tearDownClass(cls):
        if not cls.setupClass_is_run:
            return
        cls.right_vm_fixture.cleanUp()
        cls.left_vm_fixture.cleanUp()
        cls.left_vn_fixture.cleanUp()
        cls.right_vn_fixture.cleanUp()
        cls.mgmt_vn_fixture.cleanUp()
