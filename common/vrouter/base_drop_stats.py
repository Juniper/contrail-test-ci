...
class BaseDropStats(GenericTestBase) :
    ...
    def get_drop_stats_dict(self, compute, ip=None, module='vif'):
        if module == 'vrouter':
    ...
    def verify_flow_action_drop_stats(self, drop_type='ds_flow_action_drop'):
        ...
        vif_dict_before = self.get_drop_stats_dict(compute0, ip_addr)
        ...
        count = 0
        while True:
            vif_dict_after = self.get_drop_stats_dict(compute0, ip_addr)
