...
class TestInputs(object):
    ...
    def _process_other_orchestrators(self,json_data):
        ...
        self.if_vcenter_gw_setup = False
        self.if_vcenter_present_in_this_setup = False
    ...
    def get_mysql_token(self):
        ...
        if self.orchestrator == 'vcenter' or self.if_vcenter_present_in_this_setup:
            return None
        if self.devstack:
            return 'contrail123'
