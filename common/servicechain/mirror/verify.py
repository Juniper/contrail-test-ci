...
#        for svm_name, (session, pcap) in sessions.items():
#            svm = {}
#            svm = self.get_svms_in_si(self.si_fixtures[0])
...
#            right_vm_fixture.vm_ip), errmsg
#        svmname = self.get_svms_in_si(si_fixture)[0].name
#        for svm_name, (session, pcap) in sessions.items():
#            count = 10
#            # Why is below check needed
#            if svm_name == svmname:
#                count = 0
#            if left_vm_fixture.vm_node_ip != right_vm_fixture.vm_node_ip:
#                count = count * 2
...
#            sport, dport)
#        assert sent and recv == sent, errmsg
#        svmname = self.get_svms_in_si(self.si_fixtures[0])[0].name
#        for svm_name, (session, pcap) in sessions.items():
#            count = sent
#            if svm_name == svmname:
#                count = 0
