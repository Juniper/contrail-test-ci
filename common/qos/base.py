...
class QosTestBase(BaseNeutronTest):
    ...
    def setup_qos_config(self, name=None, dscp_map={}, dot1p_map={}, exp_map={}, **kwargs):
...
#                            tcp=tcp,
    ...
    def update_policy_qos_config(self, policy_fixture, qos_config_fixture, operation = "add"):
        ...
        if operation == "add":
            qos_obj_fq_name_str = self.vnc_lib.qos_config_read(
                                    id = qos_config_fixture.uuid).get_fq_name_str()
            new_policy_entry['policy_rule'][0]['action_list']['qos_action'] = \
                                    qos_obj_fq_name_str
    ...
    def update_sg_qos_config(self, sg_fixture, qos_config_fixture, operation = "add"):
