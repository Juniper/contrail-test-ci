...
class VncWrap:
   ...
   def __init__ (self, **kwargs):
       ...
       self.project = self._get('project', kwargs['project_id'])
       self._export_fns()

   def _get (self, resource, fq_name_or_id):
       fn_name = resource + '_read'
