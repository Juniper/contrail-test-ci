...
RUN  $merge_code $fab_utils_mv cd /contrail-test && pip install -r --extra-index-url https://svl-artifactory.juniper.net/artifactory/api/pypi/pypi-virtual/simple/ requirements.txt
