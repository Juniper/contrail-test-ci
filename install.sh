...
if [ ${BUILD_PLATFORM} = "16.04" ]; then
    ...
    CONFLICT_PKGS="http://10.84.5.120/cs-shared/builder/cache/ubuntu1604/newton/contrail-test/libxml2-dev_2.9.3+dfsg1-1ubuntu0.2_amd64.deb http://10.84.5.120/cs-shared/builder/cache/ubuntu1604/newton/contrail-test/libxml2_2.9.3+dfsg1-1ubuntu0.2_amd64.deb http://10.84.5.120/cs-shared/builder/cache/ubuntu1604/newton/contrail-test/libxslt1-dev_1.1.28-2.1ubuntu0.1_amd64.deb http://10.84.5.120/cs-shared/builder/cache/ubuntu1604/newton/contrail-test/libxslt1.1_1.1.28-2.1ubuntu0.1_amd64.deb"
else
