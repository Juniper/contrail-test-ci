...
def configure_test_env(contrail_fab_path='/opt/contrail/utils', test_dir='/contrail-test'):
    ...
    ixia_linux_username = None
    ixia_linux_password = None
    spirent_linux_username = None
    spirent_linux_password = None
	...
	if 'ixia_linux_username' in sanity_testbed_dict['traffic_data']:
	    ixia_linux_username = sanity_testbed_dict['traffic_data']['ixia_linux_username']
	if 'ixia_linux_password' in sanity_testbed_dict['traffic_data']:
	    ixia_linux_password = sanity_testbed_dict['traffic_data']['ixia_linux_password']
	if 'spirent_linux_username' in sanity_testbed_dict['traffic_data']:
	    spirent_linux_username = sanity_testbed_dict['traffic_data']['spirent_linux_username']
	if 'spirent_linux_password' in sanity_testbed_dict['traffic_data']:
	    spirent_linux_password = sanity_testbed_dict['traffic_data']['spirent_linux_password']
