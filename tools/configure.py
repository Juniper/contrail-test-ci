...
def configure_test_env(contrail_fab_path='/opt/contrail/utils', test_dir='/contrail-test'):
    ...
    if auth_protocol == 'https':
        ...
        openstack_host_password = get_env_passwords(openstack_host)
        copy_cert_ca_key_file(key_ssl_cert_files_list, openstack_host, openstack_host_password)
...
def copy_cert_ca_key_file(ssl_cert_files_list, source_host, password):
    ...
    scp_cmd = 'sshpass -p ' + password + ' scp -r '
