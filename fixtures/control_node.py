...
class CNFixture(fixtures.Fixture):
    ...
    def set_graceful_restart(self,**kwargs):
        gr_restart_time = kwargs['gr_restart_time']
        llgr_restart_time = kwargs['llgr_restart_time']
        eor_timeout = kwargs['eor_timeout']
        gr_enable = kwargs['gr_enable']
        bgp_helper_enable = kwargs['bgp_helper_enable']
        xmpp_helper_enable = kwargs['xmpp_helper_enable']
        router_asn = kwargs['router_asn']
 
        vnc_lib = self.vnc_lib_h
        gsc_obj = vnc_lib.global_system_config_read(
                  fq_name=['default-global-system-config']) 
        gsc_obj.set_autonomous_system(self.router_asn)
