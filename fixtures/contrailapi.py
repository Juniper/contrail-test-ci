...
class ContrailVncApi:
    ...
    def create_route_table(self, name,route_table_type = 'interface', parent_obj=None, prefixes=[], next_hop='', next_hop_type = 'ip-address'):
        ...
        Args:
            ...
            route_table_type : type of static table needed. Either interface type table or network type table
                               This also defines the parameters to be passed. Interface only needs prefix.
                               Network type would need atleast next-hop ip with prefix
            prefixes : list of x.y.z.a/mask entries for Interface route table
