...
class WebuiTest:
    ...
    def disassoc_phy_router_under_bgp_router(self, fixture):
        result = True
        try:
    ...
    def create_bgp_router(self, fixture):
        ...
        try:
            ...
            if not self.ui.select_from_dropdown(fixture.router_type, grep=False):
                    result = result and False
            ...
            if not self.ui.select_from_dropdown(fixture.auth_type, grep=False):
                result = result and False
            if fixture.auth_type == 'md5':
                self.ui.send_keys(fixture.auth_key, 'user_created_auth_key', 'name',
                                 clear=True)
            self.ui.click_element('s2id_user_created_physical_router_dropdown')
            ...
            self.ui.send_keys(fixture.hold_time, 'hold_time', 'name', clear=True)
            self.ui.click_on_create('BGP Router', 'bgp_router', save=True)
        except WebDriverException:
            self.logger.error(
