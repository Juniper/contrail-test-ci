    ...
    def create_service_appliance_set(self, appliance_list, appliance_params):
        ...
        try:
            for appl in appliance_list:
                ...
                click_class_elements = ['ui-accordion-header-icon', 'editable-grid-add-link']
                for click_element in click_class_elements:
                    self.ui.click_element(click_element, 'class')
