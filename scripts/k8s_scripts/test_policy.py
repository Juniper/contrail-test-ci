...
class TestNetworkPolicy(BaseK8sTest):
    ...
    def test_policy_with_namespace(self):
        ...
        '''
        ns0 = self.setup_namespace('ns0')
        ns1 = self.setup_namespace('ns1')
        ns2 = self.setup_namespace('ns2')
        self.sleep(2)
...
#            pod_selector=s1.labels,
    ...
    def test_with_no_pod_selector_and_ports(self):
        ...
        self.logger.info('Empty pod_selector matched all pods in namespace..OK')
        assert self.validate_wget(ns2_c1, s1_url, expectation=False)
    ...
    def test_with_no_ingress_rule_selectors(self):
        ...
        assert self.validate_wget(ns1_c2, ns_s1_url)
